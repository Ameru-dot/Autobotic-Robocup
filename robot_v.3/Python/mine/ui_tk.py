...
def ui_loop():
    ...
    ttk.Button(btn_frame, text="Mode: Zone", command=lambda: objective.__setattr__("value", "zone_search")).pack(side="left", padx=4)
    ...
    ttk.Button(calib_frame, text="Calib Line Green", command=lambda: (calibration_color.__setattr__("value", "line_green"), calibrate_color_status.__setattr__("value", "calibrate"))).pack(side="left", padx=4)
    ttk.Button(calib_frame, text="Calib Line Black", command=lambda: (calibration_color.__setattr__("value", "line_black"), calibrate_color_status.__setattr__("value", "calibrate"))).pack(side="left", padx=4)
    ttk.Button(calib_frame, text="Calib Line Red", command=lambda: (calibration_color.__setattr__("value", "line_red"), calibrate_color_status.__setattr__("value", "calibrate"))).pack(side="left", padx=4)
    ttk.Button(calib_frame, text="Calib Zone Green", command=lambda: (calibration_color.__setattr__("value", "zone_green"), calibrate_color_status.__setattr__("value", "calibrate"))).pack(side="left", padx=4)
    ttk.Button(calib_frame, text="Calib Zone Red", command=lambda: (calibration_color.__setattr__("value", "zone_red"), calibrate_color_status.__setattr__("value", "calibrate"))).pack(side="left", padx=4)
